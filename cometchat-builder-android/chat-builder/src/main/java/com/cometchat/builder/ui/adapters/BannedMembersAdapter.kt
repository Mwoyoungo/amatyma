...
import com.cometchat.builder.databinding.BuilderBannedMemberRowBinding
...
class BannedMembersAdapter(
    ...
    override fun onCreateViewHolder(
        ...
        val binding = BuilderBannedMemberRowBinding.inflate(
    ...
    class MyViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        var binding: BuilderBannedMemberRowBinding =
            BuilderBannedMemberRowBinding.bind(itemView) // Binding for the banned member row layout // Bind the layout to this view holder
