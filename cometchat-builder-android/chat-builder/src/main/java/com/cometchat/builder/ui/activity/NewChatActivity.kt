...
import com.cometchat.builder.databinding.BuilderActivityNewChatBinding
...
class NewChatActivity : AppCompatActivity() {
    private lateinit var binding: BuilderActivityNewChatBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = BuilderActivityNewChatBinding.inflate(layoutInflater)
        ...
        binding.tabLayout.addTab(binding.tabLayout.newTab().setText(resources.getString(R.string.builder_bottom_nav_users)))
        binding.tabLayout.addTab(binding.tabLayout.newTab().setText(resources.getString(R.string.builder_bottom_nav_groups)))
