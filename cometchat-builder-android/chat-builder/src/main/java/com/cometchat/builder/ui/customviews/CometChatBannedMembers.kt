package com.cometchat.builder.ui.customviews
...
import com.cometchat.builder.data.interfaces.OnBackPress
import com.cometchat.builder.databinding.BuilderBannedMemberCustomViewBinding
import com.cometchat.builder.ui.adapters.BannedMembersAdapter
import com.cometchat.builder.viewmodels.BannedMembersViewModel
...
class CometChatBannedMembers @JvmOverloads constructor(
    ...
    private lateinit var binding: BuilderBannedMemberCustomViewBinding
    ...
    private fun inflateAndInitializeView(
        ...
        binding = BuilderBannedMemberCustomViewBinding.inflate(
            LayoutInflater.from(
                context
            ), this, true
        )
    ...
    private fun showConfirmationAlertDialog(
        ...
        confirmDialog!!.confirmDialogIcon = ResourcesCompat.getDrawable(
            resources, R.drawable.builder_ic_leave_group, null
        )
