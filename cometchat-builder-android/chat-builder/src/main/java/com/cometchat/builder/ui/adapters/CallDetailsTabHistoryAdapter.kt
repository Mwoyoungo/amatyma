...
import com.cometchat.builder.databinding.BuilderCallDetailsHistoryItemsBinding
...
class CallDetailsTabHistoryAdapter(private val context: Context) : RecyclerView.Adapter<CallDetailsTabHistoryAdapter.MyViewHolder>() {
    ...
    override fun onCreateViewHolder(
        ...
        val binding = BuilderCallDetailsHistoryItemsBinding.inflate(
    ...
    override fun onBindViewHolder(
        ...
        if (callLog.type == CometChatCallsConstants.CALL_TYPE_AUDIO || callLog.type == CometChatCallsConstants.CALL_TYPE_VIDEO || callLog.type == CometChatCallsConstants.CALL_TYPE_AUDIO_VIDEO) {
            if (isLoggedInUser) {
                holder.binding.tvInfoTitle.setText(R.string.builder_call_outgoing)
                ...
                holder.binding.tvInfoTitle.setText(R.string.builder_call_missed)
                holder.binding.tvInfoTitle.setTextAppearance(
                    CometChatTheme.getTextAppearanceHeading4Medium(
                        context
                    )
                ...
                holder.binding.tvInfoTitle.setText(R.string.builder_call_incoming)
                holder.binding.tvInfoTitle.setTextAppearance(
                    CometChatTheme.getTextAppearanceHeading4Medium(
                        context
                    )
    ...
    class MyViewHolder(var binding: BuilderCallDetailsHistoryItemsBinding) : RecyclerView.ViewHolder(binding.root)
}
