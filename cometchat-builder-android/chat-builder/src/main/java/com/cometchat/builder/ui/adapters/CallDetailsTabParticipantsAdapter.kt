...
import com.cometchat.builder.databinding.BuilderCallDetailsParticipantsItemsBinding
...
class CallDetailsTabParticipantsAdapter
    ...
    override fun onCreateViewHolder(
        ...
        val binding = BuilderCallDetailsParticipantsItemsBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    ...
    class MyViewHolder(var binding: BuilderCallDetailsParticipantsItemsBinding) : RecyclerView.ViewHolder(binding.root)
}
