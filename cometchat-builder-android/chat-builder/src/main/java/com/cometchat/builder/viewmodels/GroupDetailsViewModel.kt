package com.cometchat.builder.viewmodels
...
class GroupDetailsViewModel : ViewModel() {
    ...
    private fun postCompleteError(context: Context, groupName: String?, userName: String) {
        val message = if (!groupName.isNullOrBlank()) {
            context.getString(R.string.builder_participant_scope_with_group, userName, groupName)
        } else {
            context.getString(R.string.builder_participant_scope_without_group, userName)
        }
