...
import com.cometchat.builder.CometChatBuilderSettings.ChatFeatures.GroupManagement.CREATEGROUP
...
import com.cometchat.builder.databinding.BuilderCreateGroupLayoutBinding
import com.cometchat.builder.databinding.BuilderFragmentGroupsBinding
import com.cometchat.builder.databinding.BuilderJoinPasswordGroupLayoutBinding
...
import com.cometchat.builder.viewmodels.GroupsViewModel
...
class GroupsFragment : Fragment() {
    ...
    private lateinit var binding: BuilderFragmentGroupsBinding
    ...
    override fun onCreateView(
        ...
        binding = BuilderFragmentGroupsBinding.inflate(inflater, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if (CREATEGROUP) setOverFlowMenu()
    }
    ...
    private fun setOverFlowMenu() {
        val overflowMenuLayoutBinding = BuilderOverflowMenuLayoutBinding.inflate(
            layoutInflater
        )
    ...
    private fun openCreateGroupDialog() {
        val createGroupLayoutBinding = BuilderCreateGroupLayoutBinding.inflate(
            layoutInflater
        )
     ...
     */
    private fun updateRadioButtonTextColors(binding: BuilderCreateGroupLayoutBinding, selectedColor: Int, unselectedColor: Int) {
     ...
     */
    private fun hidePasswordField(createGroupLayoutBinding: BuilderCreateGroupLayoutBinding) {
     ...
     * The binding object for the create group layout.
     */
    private fun showPasswordField(createGroupLayoutBinding: BuilderCreateGroupLayoutBinding) {
    ...
    private fun openJoinPasswordGroupDialog(group: Group) {
        val joinPasswordGroupLayoutBinding = BuilderJoinPasswordGroupLayoutBinding.inflate(layoutInflater)
    ...
    private fun scrollCreateGroupToBottom(createGroupLayoutBinding: BuilderCreateGroupLayoutBinding, delay: Int) {
