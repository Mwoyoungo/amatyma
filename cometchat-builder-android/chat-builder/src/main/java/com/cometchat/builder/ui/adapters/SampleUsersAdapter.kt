...
import com.cometchat.builder.data.interfaces.OnSampleUserSelected
import com.cometchat.builder.databinding.BuilderSampleUserItemsBinding
...
class SampleUsersAdapter(
    ...
    override fun onCreateViewHolder(
        ...
        val binding = BuilderSampleUserItemsBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    ...
    class UserViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        var binding: BuilderSampleUserItemsBinding = BuilderSampleUserItemsBinding.bind(itemView)
    }
}
