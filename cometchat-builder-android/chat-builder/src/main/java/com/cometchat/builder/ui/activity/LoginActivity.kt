...
import com.cometchat.builder.databinding.BuilderActivityLoginBinding
import com.cometchat.builder.ui.adapters.SampleUsersAdapter
import com.cometchat.builder.viewmodels.LoginViewModel

class LoginActivity : AppCompatActivity() {
    private lateinit var binding: BuilderActivityLoginBinding
    private lateinit var viewModel: LoginViewModel
    private var sampleUsersAdapter: SampleUsersAdapter? = null

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = BuilderActivityLoginBinding.inflate(layoutInflater)
            ...
            if (viewModel.selectedUser.value == null && binding.etUid.text.toString().isEmpty()) {
                Toast.makeText(
                    this@LoginActivity, ContextCompat.getString(
                        this@LoginActivity, R.string.builder_error_invalid_user_or_uid_login
                    ), Toast.LENGTH_SHORT
                ).show()
            } else {
