package com.cometchat.builder.utils
...
import com.cometchat.builder.databinding.BuilderCustomToastBinding
...
object AppUtils {
    ...
    fun customToast(
        ...
        val binding = BuilderCustomToastBinding.inflate(LayoutInflater.from(context))
    ...
    fun <T> saveDataInSharedPref(
        ...
        val sharedPreferences = context.getSharedPreferences(
            context.getString(R.string.builder_shared_pref), Context.MODE_PRIVATE
        )
    ...
    fun isAgentChat(user: User?): Boolean {
        return user != null && user.role.equals("@agentic")
    }
